...
#$ -cwd
#$ -o logs/fep/
# MUST equal fep.legs * fep.lambda_windows * fep.replicates (2*20*3). SGE cannot template
# this from config, so the guard below re-derives it and aborts on a mismatch. If you raise
# fep.replicates to 5, change this to 1-200 IN THE SAME COMMIT or every task exits 2.
# 108 -> 120 on 2026-08-15 with fep.lambda_windows 18 -> 20 (F64A endpoint refinement).
#$ -t 1-120
